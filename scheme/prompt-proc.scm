...
(define*-public (gtk-proc-selection-new title #&optional (proclist #f))
  ...
  (let* ((toplevel (gtk-window-new 'dialog))
    ...
    (gtk-clist-set-column-resizeable clist 2 #t)
    (gtk-clist-set-column-resizeable clist 3 #t)
    (gtk-clist-set-column-resizeable clist 4 #t)
    ...
    (gtk-clist-set-column-justification clist 2 'left)
    (gtk-clist-set-column-justification clist 3 'left)
    (gtk-clist-set-column-justification clist 4 'left)
    (for-each (lambda (mp) 
