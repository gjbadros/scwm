 ...
 ****************************************************************************/
void 
ParseMouseEntry(XEvent * eventp, Window w, ScwmWindow * tmp_win,
		unsigned long junk, char *tline, int *Module)
{
  ...
  if ((n1 != 1) || (n2 != 1) || (n3 != 1)) {
    scwm_msg(ERR, "ParseMouseEntry", "Mouse binding: Syntax error in line %s",
	     tline);
    return;
  }
 ...
 ****************************************************************************/
void 
ParseKeyEntry(XEvent * eventp, Window w, ScwmWindow * tmp_win,
	      unsigned long junk, char *tline, int *Module)
{
