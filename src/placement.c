...
int test_fit(ScwmWindow *t, int x11, int y11, int aoimin)
{
  int height;
  int width;
  ScwmWindow *testw;
 ...
 *
 **************************************************************************/
Bool PlaceWindow(ScwmWindow *tmp_win, unsigned long tflag,int Desk)
{
  ScwmWindow *t;
...
void GetGravityOffsets (ScwmWindow *tmp,int *xp,int *yp)
{
