...
{
  return scm_from_int(Scr.CurrentDesk);
}
#undef FUNC_NAME
...
{
  return scm_list_n(scm_from_int(Scr.Vx),
		    scm_from_int(Scr.Vy),
		    SCM_UNDEFINED);
}
#undef FUNC_NAME
...
{
  return scm_from_int(Scr.EdgeScrollX);
}
#undef FUNC_NAME
...
{
  return scm_from_int(Scr.EdgeScrollY);
}
#undef FUNC_NAME
...
{
  return scm_from_bool(Scr.fEdgeWrapX);
}
#undef FUNC_NAME
...
{
  return scm_from_bool(Scr.fEdgeWrapY);
}
#undef FUNC_NAME
...
{
  return scm_from_int(Scr.ScrollResistance);
}
#undef FUNC_NAME
...
{
  return scm_from_int(Scr.MoveResistance);
}
#undef FUNC_NAME
...
#define FUNC_NAME s_set_desk_size_x
{
  ...
  scwm_run_hook2(desk_size_change_hook,
                 scm_from_ulong(Scr.VxMax / Scr.DisplayWidth + 1),
                 scm_from_ulong(Scr.VyMax / Scr.DisplayHeight + 1));
...
{
  return scm_list_n(scm_from_int((int) (Scr.VxMax / Scr.DisplayWidth + 1)),
		    scm_from_int((int) (Scr.VyMax / Scr.DisplayHeight + 1)),
		    SCM_UNDEFINED);
}
#undef FUNC_NAME
...
{
  return scm_list_n(scm_from_int(Scr.DisplayWidth),
		    scm_from_int(Scr.DisplayHeight),
		    SCM_UNDEFINED);
}
#undef FUNC_NAME
